...
// Originally part of the Firesheep project,
// adapted to the GoodShephard project
//
...
//
// Modified for use in the GoodShephard project
//   by Andy Nunes <ajnunes@calpoly.edu>
//
...
{
  if (payload_size > 0) {
    int len = (int)http_parser_execute(&m_parser, &m_settings, payload, payload_size);
